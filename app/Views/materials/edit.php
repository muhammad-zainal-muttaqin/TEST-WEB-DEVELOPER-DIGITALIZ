...
<body>
    ...
    <div class="container mt-4">
        ...
        <form action="<?= site_url('materials/update/' . $material['id']) ?>" method="post" class="needs-validation" novalidate>
        ...
        <a href="<?= site_url('materials') ?>" class="btn btn-secondary mt-3">Kembali ke Daftar Materi</a>
    </div>
